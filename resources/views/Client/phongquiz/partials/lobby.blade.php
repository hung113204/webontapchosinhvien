        ...
        <div class="qv-lobby-center">
            ...
            <div class="qv-lobby-info-badges">
                <div class="qv-info-badge">
                    <span id="lobby-subject">Môn học</span>
                </div>
                <div class="qv-info-badge">
                    <span id="lobby-level">Mức độ</span>
                </div>
                <div class="qv-info-badge">
                    ...
                    <span id="lobby-member-count">1/50</span>
                </div>
            </div>
        </div>
        ...
        <div class="qv-lobby-two-column">
            <div class="qv-lobby-column">
                <div class="qv-lobby-col-header">
                    ...
                    <div class="qv-lobby-section-count" id="lobby-player-count">1 người</div>
                </div>
